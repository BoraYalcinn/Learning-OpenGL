...
int main() {
    ...
    shinyMaterial = Material(3.0f, 256);
    ...
    GLuint uniformProjection = 0, uniformModel = 0, uniformView = 0,  uniformSpecularIntensity = 0,uniformShininess = 0,uniformEyePosition = 0;
